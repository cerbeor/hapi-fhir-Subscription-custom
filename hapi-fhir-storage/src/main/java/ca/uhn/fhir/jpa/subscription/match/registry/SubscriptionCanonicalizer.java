...
//				ourLog.warn("topic element : {}", topicElement);
				org.hl7.fhir.r5.model.SubscriptionTopic topic = (org.hl7.fhir.r5.model.SubscriptionTopic) subscription.getContained().get(0);
//					.stream().filter(t -> {
//					try {
//						return ("#" + ( t).getId()).equals(topicElement) ||
//							(( t).getId()).equals(topicElement);
